...
import com.sa7i7alboukhari.entity.Page;
...
//			    switch (params[0]) {
//			    case 0:
//			     return SABManager.getInstance(MainActivity.this).getBooksByPage(o);
//			    case 1:
//			     return SABManager.getInstance(MainActivity.this).getChaptersByPage(o);
//			    case 2:
//			     return SABManager.getInstance(MainActivity.this).getAhadithByPage(o);
//			    default:
//			     return null;
//			    }
			    return true;
